...
class Book extends React.Component {
  ...
  render() {
    ...
    this.props.values.shelf = this.props.book.shelf
      ...
      <div className="book">
        <div className="top">
          <div className="cover" style={{ width: 128, height: 193, backgroundImage: 'url('+this.props.values.url+')' }}></div>
        ...
        <div className="title">{this.props.values.title}</div>
        <div className="authors">{this.props.values.authors.join(', ')}</div>
      </div>
    )
  }
}
